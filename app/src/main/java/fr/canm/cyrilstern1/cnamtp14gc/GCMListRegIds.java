...
public class GCMListRegIds implements Iterable<String> {
    ...
    public static final String LIST_STERN = "liste_125";  // c'est le nom de la liste globale, partagée par tous
    ...
    private static final String URL_CNAM_SERVEUR = "http://jfod.cnam.fr/jnews/tests/http_list.html";
    ...
    public GCMListRegIds(Context context, String name) {
        this(context, name, URL_CNAM_SERVEUR);
